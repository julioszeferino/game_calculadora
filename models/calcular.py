from random import randint # biblioteca pra gerar valores inteiros aleatorios
...
class Calcular:
    ...
    def __str__(self: object) -> str:
        '''
        Funcao que retorna a descricao do que o jogo ira executar

        Se for igual a 1, o jogo executa a operacao somar.
        Se for igual a 2, o jogo executa a operacao diminuir.
        Se for igual a 13, o jogo executa a operacao Multiplicar.
        '''
        op: str = ''
        if self.operacao == 1:
            op = 'Somar'
